...
export const INGREDIENTS: Ingredient[] = [
  ...
  { slug: "pita-wg",        name: "Whole-grain pitas",   category: "bakery",  unit: "each" },
  { slug: "bagel-wg",       name: "Whole-grain bagels",  category: "bakery",  unit: "each" },
  { slug: "cream-cheese",   name: "Cream cheese",        category: "dairy",   unit: "tbsp" },
  { slug: "cucumber",       name: "Cucumber",            category: "produce", unit: "each" },
  { slug: "celery",         name: "Celery",              category: "produce", unit: "cup" },
  { slug: "grapes",         name: "Grapes",              category: "produce", unit: "cup" },
  { slug: "avocado",        name: "Avocado",             category: "produce", unit: "each" },
  { slug: "beef-strips",    name: "Flank or sirloin steak", category: "protein", unit: "lb" },
  { slug: "tuna-canned",    name: "Canned light tuna",   category: "pantry",  unit: "each" },
  { slug: "chicken-stock",  name: "Low-sodium stock",    category: "pantry",  unit: "cup" },
