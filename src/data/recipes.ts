...
export const RECIPES: Recipe[] = [
  ...
  // ────────── HIBACHI (signature recipe) ──────────
  {
    ...
    servings: 8,
    totalMinutes: 25,
    imageUrl: "/images/recipes/hibachi-chicken.jpg",
  ...
  },
  {
    ...
    servings: 6,
    totalMinutes: 10,
    // Stock photograph, checked at card size against this recipe's own ingredient list
  ...
  },
  {
    ...
    prepAhead: {
      yields: "6 servings. Dinner tonight and lunches after.",
      keepsDays: 4,
      freezerDays: 90,
      reheat: "Gently on the stove with a splash of water. Rice keeps drinking liquid overnight.",
    },
    steps: [
      {
        order: 1,
        title: "Everything except the rice, in the morning",
        body: "1.5 lb chicken breast, 2 diced carrots, 2 cloves garlic, 8 cups of stock or water with salt. Low for 6 hours. The chicken goes in whole and shreds later, which keeps it far juicier than cubing it first.",
      },
      {
        order: 2,
        title: "Rice in for the last 30 minutes only",
        body: "Add 1 cup of jasmine rice half an hour before you eat. Rice cooked for six hours in a slow cooker disintegrates into paste and thickens the whole pot into porridge.",
        timerSec: 1800,
        mistake: "Adding the rice in the morning with everything else. It is the single most common way this dish is ruined.",
      },
      {
        order: 3,
        title: "Shred the chicken in the pot",
        body: "Two forks, straight in the pot. It falls apart after six hours and the shreds carry broth in a way cubes do not.",
      },
      {
        order: 4,
        title: "Taste for salt at the end, not the start",
        body: "Liquid reduces over six hours and salt concentrates. Salted in the morning it is usually too salty by evening.",
      },
    ],
    notes: [
      "This is the recipe for a night when practice runs to 7pm and nobody wants to start cooking.",
      "Freeze without the rice if you can, and add fresh rice on reheating. Frozen and thawed rice in soup goes mushy.",
      "About 32 g of protein a serving.",
      "Six hours on low, not four on high. High heat makes chicken breast stringy.",
    ],
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Rice on first, it is the long pole",
        body: "1.5 cups of jasmine rice, rinsed, with 2.25 cups of water. Lid on, low, 18 minutes, then off the heat with the lid still on. Everything else finishes inside that window.",
        timerSec: 1080,
      },
      {
        order: 2,
        title: "Salmon skin side down, 400F, twelve minutes",
        body: "Four fillets of about 6 oz, patted dry, olive oil, salt, lemon. Twelve minutes at 400F for a fillet an inch thick. It is done when it flakes with gentle pressure and still looks slightly translucent at the very centre.",
        timerSec: 720,
        mistake: "Cooking it until it is uniformly opaque. That is several minutes past done, and it is why people think they dislike salmon.",
      },
      {
        order: 3,
        title: "Broccoli steamed, not boiled",
        body: "4 cups of florets, steamed 5 minutes until bright green and still firm. Boiled broccoli goes grey and soft, which is the version children refuse on sight.",
        timerSec: 300,
      },
      {
        order: 4,
        title: "Lemon over everything at the table",
        body: "Half a lemon squeezed across the plate. Salmon and lemon is not a garnish, it is what stops it tasting heavy.",
      },
    ],
    notes: [
      "Salmon twice a week is a reasonable target and this is deliberately a different shape from the sheet pan version.",
      "Frozen fillets are fine and much cheaper. Thaw overnight in the fridge, never on the counter.",
      "About 40 g of protein a serving plus the omega-3, which is the actual reason salmon is on this site.",
      "If he will not eat salmon, the same method works with any firm white fish at 10 minutes instead of 12.",
    ],
  },
  {
    ...
    prepAhead: {
      yields: "4 servings, and it reheats better than most stir-fries",
      keepsDays: 3,
      reheat: "Hot pan, one minute. The microwave makes the vegetables limp.",
    },
    steps: [
      {
        order: 1,
        title: "Slice the beef across the grain, thin",
        body: "1 lb of flank or sirloin, sliced against the grain into strips about an eighth of an inch. Cutting with the grain gives you chewy beef whatever you do next, and this is the step that decides the whole dish.",
        mistake: "Slicing thick or with the grain. No amount of cooking fixes either.",
      },
      {
        order: 2,
        title: "Pan screaming hot, beef in one layer, do not stir",
        body: "High heat, 1 tbsp oil, beef in a single layer. Leave it 90 seconds to sear before touching it. Crowded or stirred it steams grey instead of browning, and stir-fry is mostly about that crust.",
        timerSec: 90,
      },
      {
        order: 3,
        title: "Beef out, vegetables in",
        body: "Take the beef out while it is still slightly pink. Then 2 cups of broccoli and a sliced bell pepper into the same pan for 3 minutes, with 2 cloves of garlic in the last 30 seconds so it does not burn.",
        timerSec: 180,
      },
      {
        order: 4,
        title: "Beef back in, sauce, thirty seconds",
        body: "Beef returns, 2 tbsp low-sodium soy sauce and 1 tsp sesame oil, tossed for half a minute. The beef finishes on residual heat, which is why it stays tender.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    prepAhead: {
      yields: "4 dinners, or 2 dinners and 2 lunch bowls",
      keepsDays: 4,
      reheat: "Chicken and peppers in a pan, rice separately with a splash of water.",
    },
    steps: [
      {
        order: 1,
        title: "Peppers and onion first, hard and fast",
        body: "Two bell peppers sliced, into a very hot pan with 1 tbsp oil for 5 minutes, barely stirred, until they have black edges. Those charred edges are the entire flavour of fajitas and gentle cooking gives you none of them.",
        timerSec: 300,
      },
      {
        order: 2,
        title: "Peppers out, chicken in",
        body: "1.5 lb of chicken breast in strips, seasoned with 2 tsp of taco seasoning, into the same pan. Six to eight minutes, turned once. Cooking them together steams both.",
        timerSec: 420,
        mistake: "Everything in the pan at once. The peppers release water, the chicken poaches in it, and nothing browns.",
      },
      {
        order: 3,
        title: "Build it as a bar, not a plate",
        body: "Rice in the bowls, then chicken and peppers, then everything else on the table in separate bowls: cheese, lettuce, tomato, lime. A child who assembles their own dinner eats considerably more of it than one handed a finished plate.",
      },
    ],
    notes: [
      "The self-assembly is the nutritional strategy here, not a serving suggestion. It is the most reliable vegetable delivery on this site.",
      "Leftovers become the quesadilla recipe the next day.",
      "About 42 g of protein a serving before toppings.",
      "Taco seasoning varies wildly in salt. Check the label or make your own with cumin, paprika and garlic powder.",
    ],
  },
  {
    ...
    prepAhead: {
      yields: "4 servings, and it is one of the few bakes that freezes and reheats well",
      keepsDays: 3,
      freezerDays: 60,
      reheat: "Covered, 350F, 20 minutes from chilled. Uncover for the last five.",
    },
    steps: [
      {
        order: 1,
        title: "Undercook the pasta by two minutes",
        body: "16 oz of whole-grain pasta, two minutes short of the box time. It cooks again in the oven, and pasta taken to al dente in the pot comes out of the bake soft.",
      },
      {
        order: 2,
        title: "Drain the tuna properly",
        body: "Two cans, drained hard, pressed against the lid. Tuna water left in makes the bake watery and gives it the smell people associate with tuna bake going wrong.",
        mistake: "Tipping the cans in with their liquid to save a step. It is the difference between a bake and a soup.",
      },
      {
        order: 3,
        title: "Fold everything cold, then bake",
        body: "Pasta, tuna, 2 cups of marinara, 2 cups of broccoli florets, folded gently in the dish. Cheese over the top. 375F for 20 minutes until the top is browned and the edges bubble.",
        timerSec: 1200,
      },
    ],
    notes: [
  ...
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Rice on the bottom, cold, spread flat",
        body: "One cup of cooked rice, spread rather than piled. This is a method, not a recipe: rice, a protein, a vegetable, something with flavour. Any three things from the fridge assemble into a lunch this way.",
      },
      {
        order: 2,
        title: "Protein in its own corner",
        body: "About 4 oz of whatever is left: hibachi chicken, taco turkey, the salmon from last night, two boiled eggs. Corners rather than layers, so nothing sheds moisture into the rice.",
      },
      {
        order: 3,
        title: "One vegetable and one sauce, the sauce separate",
        body: "Whatever roasted or steamed vegetable exists, and a sauce cup on the side. Soy, yum-yum, a squeeze of lime. The sauce is what makes leftovers taste deliberate rather than scraped together.",
        mistake: "Dressing it at 7am. Six hours later the rice has absorbed everything and the whole box is one texture.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    prepAhead: {
      yields: "4 lunches from one bowl",
      keepsDays: 3,
      reheat: "None, eaten cold. Fill the pita in the morning, not on Sunday.",
    },
    steps: [
      {
        order: 1,
        title: "Greek yogurt, not mayonnaise",
        body: "Half a cup of plain Greek yogurt to 12 oz of shredded cooked chicken. It tastes close enough that most kids do not notice, and it turns a fat-heavy filling into one carrying about 10 g of extra protein.",
      },
      {
        order: 2,
        title: "Something crunchy, chopped small",
        body: "Half a cup of finely diced celery or bell pepper. Small enough that it cannot be picked out, which is the difference between a child eating it and performing surgery on it.",
        mistake: "Large chunks of vegetable. They get removed one by one and left on the side of the plate.",
      },
      {
        order: 3,
        title: "Salt, lemon, and let it sit",
        body: "Salt, pepper, and the juice of half a lemon. Half an hour in the fridge before it is used: the yogurt is bland straight away and tastes properly seasoned once it has sat.",
      },
      {
        order: 4,
        title: "Fill the pita in the morning",
        body: "Whole-grain pita, filled at packing time. Filled the night before it is a wet pocket by lunch.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Toast the bagel, then let it cool",
        body: "Toasting firms the surface so the cream cheese sits on it rather than soaking in. Cooling before filling stops the whole thing steaming itself soft in the container.",
      },
      {
        order: 2,
        title: "Cream cheese right to the edges, both halves",
        body: "About 2 tbsp total, spread all the way out. The edges are where moisture gets in, and a bare rim is where a bagel lunch goes soggy first.",
      },
      {
        order: 3,
        title: "Turkey folded, cucumber last",
        body: "3 oz of turkey in loose folds, then thin cucumber. Cucumber against cream cheese rather than against the bagel, because it holds a lot of water.",
        mistake: "Cucumber straight onto the bread. It is the wettest thing in a normal lunchbox.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    prepAhead: {
      yields: "4 lunches, and they genuinely hold four days",
      keepsDays: 4,
      reheat: "None. Shake the jar into a bowl, or eat it out of the jar.",
    },
    steps: [
      {
        order: 1,
        title: "Dressing in the bottom, and nothing else touches it",
        body: "Two tablespoons of olive oil and lemon in the base of each jar. This layer order is the entire technique: the dressing stays at the bottom until the jar is shaken, so nothing marinates for four days.",
        mistake: "Tossing the salad and then jarring it. That is a normal salad and it is slime by Tuesday.",
      },
      {
        order: 2,
        title: "Hard things next, leaves last",
        body: "Carrot, pepper and tomato on top of the dressing, then the chicken, then the leaves right at the top where they stay dry. Heaviest to lightest, bottom to top.",
      },
      {
        order: 3,
        title: "Pack the jar full",
        body: "Air is what wilts leaves. A jar filled to the lid keeps them crisp noticeably longer than a half-empty one.",
      },
      {
        order: 4,
        title: "Shake it at lunch",
        body: "Lid on, shake hard, tip into a bowl or eat from the jar. The dressing coats everything on the way up.",
      },
    ],
    notes: [
  ...
  },
  {
    ...
    whenToEat: "The bag snack you make on Sunday. Twelve of them, no oven.",
    equipment: ["Mixing bowl", "Sheet pan", "Parchment"],
    prepAhead: {
      yields: "12 balls from one bowl",
      keepsDays: 7,
      freezerDays: 90,
      reheat: "None. Good straight from the fridge or the freezer.",
    },
    steps: [
      {
        order: 1,
        title: "Wet into dry, not the other way round",
        body: "One cup of rolled oats and 2 tbsp of hemp hearts in the bowl first, then half a cup of peanut butter and a third of a cup of honey over the top. Poured the other way the oats float and never coat.",
      },
      {
        order: 2,
        title: "Mix until it looks too dry, then stop",
        body: "It should just hold together when squeezed, not look like dough. Wetter than that and the balls flatten into discs in the fridge.",
        mistake: "Adding more honey because it looks crumbly. It comes together under pressure in your hands, and honey is the thing that makes them sticky rather than firm.",
      },
      {
        order: 3,
        title: "Chill the mix before rolling",
        body: "Thirty minutes in the fridge. Rolled warm it sticks to your hands and you lose half of it to the washing up.",
        timerSec: 1800,
      },
      {
        order: 4,
        title: "Roll twelve, chill again",
        body: "Tablespoon-sized, rolled between the palms, onto parchment, back in the fridge for an hour to firm up properly.",
      },
    ],
    notes: [
      "Roughly 150 calories and 5 g of protein each, so two is a real snack before a session.",
      "They soften at room temperature, so a soccer bag in Florida needs them frozen or in a cold pack.",
      "Chocolate chips are a common addition and turn them from a snack into a treat, which is sometimes the point.",
      "Sun butter works, but the mix is looser and needs an extra 10 minutes chilling.",
    ],
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Dry pan, medium, no oil",
        body: "A whole-grain tortilla into a dry pan on medium. Oil makes it greasy before the cheese melts, and the dry pan crisps it properly.",
      },
      {
        order: 2,
        title: "Cheese on one half only, fold",
        body: "One slice of cheddar over half, fold the other half on top. Cheese to the edges leaks out and burns onto the pan.",
      },
      {
        order: 3,
        title: "Two minutes a side, then rest before cutting",
        body: "Press it flat, two minutes each side. One minute on the board before cutting, or the molten cheese runs straight out.",
        timerSec: 120,
      },
    ],
    notes: [
      "About 15 g of protein for five minutes and one pan.",
      "This is deliberately the simplest thing on the site. Not every snack needs a technique.",
      "Add leftover chicken and it becomes the quesadilla lunch recipe.",
      "Eat it before practice rather than in the car. Melted cheese in a bag is nobody's friend.",
    ],
  },
  {
    ...
    whenToEat: "In the car after a hard session. The recovery drink that has been studied for years.",
    equipment: ["Glass or bottle", "Spoon"],
    steps: [
      {
        order: 1,
        title: "Bloom the cocoa, same as everywhere else",
        body: "One tablespoon of unsweetened cocoa and 1 tbsp of honey with a splash of warm milk, stirred to a paste before the rest of the cup goes in. Cocoa on cold milk floats in dry lumps that never dissolve.",
        mistake: "Stirring cocoa straight into a cold glass. You get brown foam on top and a sludge at the bottom.",
      },
      {
        order: 2,
        title: "The rest of the milk, stir, done",
        body: "One cup of milk, stirred through. Two minutes, and it travels in a bottle in a cool bag.",
      },
    ],
    notes: [
      "Chocolate milk works as a recovery drink for an unglamorous reason: carbohydrate, protein and fluid in something a tired child will actually finish.",
      "Making it yourself rather than buying it means you control the sugar. Shop cartons often carry double.",
      "About 12 g of protein and 250 calories.",
      "Do not overthink the timing. Soon after is convenient, not urgent, for a child who eats dinner later.",
    ],
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Cheese in cubes, fruit in slices",
        body: "About an ounce of cheddar cubed and one sliced apple or a cup of grapes. Cubes and slices get picked up; a block and a whole apple sit there.",
      },
      {
        order: 2,
        title: "Put it where he walks past",
        body: "This is the whole strategy. A plate on the counter between the door and the sofa gets eaten. The same food in the fridge does not.",
      },
      {
        order: 3,
        title: "Lemon on the apple if it will sit out",
        body: "A squeeze stops browning for a couple of hours, which is how long a grazing plate actually lasts.",
      },
    ],
    notes: [
      "Deliberately the alternative to the cracker plate. Same convenience, actual food.",
      "About 8 g of protein and 5 g of fibre.",
      "Grapes should be halved lengthways for younger children. Whole grapes are a choking hazard under about four, and halving costs nothing.",
      "Two hours out is the USDA limit for the cheese, and one above 90F.",
    ],
  },
  {
    slug: "frozen-grapes",
    ...
    whenToEat: "August, after practice, when nothing warm is going to get eaten.",
    equipment: ["Sheet pan or bag", "Colander"],
    prepAhead: {
      yields: "4 portions from one bunch",
      keepsDays: 60,
      freezerDays: 60,
      reheat: "None. The entire point is that they are frozen.",
    },
    steps: [
      {
        order: 1,
        title: "Wash and dry them properly first",
        body: "Rinse, then dry thoroughly with a towel. Frozen wet, they weld into one solid lump and you serve a grape brick.",
        mistake: "Bagging them damp straight from the sink. It is the only way this goes wrong.",
      },
      {
        order: 2,
        title: "Off the stems, single layer, freeze",
        body: "Pull them off the stems, spread on a tray, freeze two hours, then bag them. Frozen loose first they stay separate.",
      },
    ],
    notes: [
      "They come out like sorbet, and in a Florida August they compete with an ice lolly on their own merits.",
      "Fast carbohydrate and fluid at the same time, which is what a kid wants after a hot session anyway.",
      "Halve them lengthways before freezing for a younger child. Frozen whole grapes are harder and the choking risk is real.",
      "Cheapest snack here by a distance.",
    ],
  },
  {
    ...
    steps: [
      {
        order: 1,
        title: "Mash the avocado with salt and lemon before it goes near the toast",
        body: "Half an avocado mashed in a bowl with salt and a squeeze of lemon. Mashed straight onto toast you cannot season it evenly, and unseasoned avocado tastes of very little.",
      },
      {
        order: 2,
        title: "Fry the egg on medium-low, covered",
        body: "A lid over a medium-low pan steams the top of the yolk so the white sets without the base going brown and rubbery. About three minutes.",
        timerSec: 180,
        mistake: "High heat for a fried egg. Crispy brown edges and a raw white is the usual result.",
      },
      {
        order: 3,
        title: "Avocado, then egg, then salt",
        body: "Toast, avocado, egg on top, a final pinch of salt and pepper on the yolk.",
      },
    ],
    notes: [
      "About 20 g of protein and a lot of monounsaturated fat, which makes it a slow breakfast. Better on a rest day than an hour before running.",
      "A ripe avocado gives slightly under gentle pressure at the stem. Rock hard ones will not mash and stringy ones are past it.",
      "This is the breakfast that got wrongly used as the photo for scrambled eggs and toast on this site for a while. Now it is a real recipe.",
      "Chilli flakes for an older athlete, left off for a younger one.",
    ],
  },
];
